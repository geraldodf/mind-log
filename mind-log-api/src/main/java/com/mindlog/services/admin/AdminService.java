...
public class AdminService {
    ...
    public AdminMetricsDTO getMetrics() {
        ...
        long activeUsersToday       = userMediaRepository.countDistinctActiveUsersToday();
        long totalMedia             = userMediaRepository.count();
        long mediaToday             = userMediaRepository.countMediaCreatedToday();
        long categoriesCreatedToday = mediaTypeRepository.countUserCategoriesCreatedToday();
        ...
        return new AdminMetricsDTO(
                ...
                totalMedia, mediaToday, categoriesCreatedToday,
                totalFollows, totalNotifications, unreadNotifications,
                mostActive);
    }
}
